...
TEST_EPOCHS=(500)
EXP_DIR=${CHECKPOINTS_DIR}/pointnet2_neigh-size${NN}_use-angle-feat_True_lambda0.1_samp-grasp${M}_match-policy-soft_posi-ratio-0.3/opt-adam_lr${LR}_lr-step${LR_STEP}_wd${WD}_epochs${TRAIN_EPOCHS}_seed${SEED}_${TRAIN_SPLIT}
